...
## 🎯 Project Overview
Jerry is a modern, responsive AI chat application built with **React 19**, **Vite**, and **Tailwind CSS 4**. It features real-time message streaming, Firebase-backed authentication, and a sleek dark-themed UI.

## 🛠️ Tech Stack & Patterns
- **Framework**: React 19 (Functional Components, Hooks).
- **Styling**: Tailwind CSS 4 (Preferred). Maintain the "Modern/Alive" dark aesthetic.
...
3.  **UI Components**: Prioritize accessibility and responsive design. Use `react-icons` for consistency.
...
- **Chat**: Core streaming functionality, markdown rendering, and "thinking" states are active.
